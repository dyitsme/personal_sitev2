  ...
  <div class="bg-gray-900 rounded-2xl p-4 md:px-16 md:py-10">
    <div class="flex flex-col-reverse md:flex-row items-center gap-y-4">
      <div class="md:text-left text-center">
        ...
        <NuxtLink href="mailto:dbyongco@outlook.com" class="block w-full md:w-[35%] text-center text-white bg-blue-500 hover:bg-blue-600 focus:bg-blue-400 md:text-3xl py-1 md:px-6 md:py-3 rounded md:rounded-lg mb-4 md:mb-10 transition duration-150">Send a message</NuxtLink>
      </div>
